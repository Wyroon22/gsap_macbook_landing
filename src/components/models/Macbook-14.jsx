...
Files: macbook-14.glb [629.72KB] > C:\Users\USER\WebstormProjects\macbook_gsap_app\public\models\macbook-14-transformed.glb [627.9KB] (0%)
...
export default function MacbookModel14(props) {
  ...
  const texture = useTexture('/screen.png');
    ...
    scene.traverse((child) => {
        if(child.isMesh) {
                //Child color only if the part name is NOT noChangeParts
            }
        })
    }, [color]);
